...
namespace DAL.DAL
{
    ...
    public partial class mjuserinfoDAL
    {
        ...
        public bool Add(mjuserinfo model)
        {
            ...
            strSql.Append("openid,nickname,headimg,userphone,sex,province,city,unionid,is_band,addtime,band_time,Oldheadimg)");
            ...
            MySqlParameter[] parameters = {
                    ...
                    new MySqlParameter("@Oldheadimg", MySqlDbType.VarChar,200)};
            ...
            parameters[11].Value = model.Oldheadimg;
        ...
        public bool Update(mjuserinfo model)
        {
            ...
            strSql.Append("Oldheadimg=@Oldheadimg");
            strSql.Append(" where id=@id ");
            MySqlParameter[] parameters = {
                    new MySqlParameter("@openid", MySqlDbType.VarChar,200),
                    new MySqlParameter("@nickname", MySqlDbType.VarChar,200),
